...
class BodySpec extends ObjectBehavior
{
    ...
    public function it_should_provide_information_if_empty_data()
    {
        $this->isEmpty()->shouldReturn(true);
    }

    public function it_should_return_empty_data()
    {
    ...
    public function it_should_add_nested_data()
    {
        $this->beConstructedWith([
            'address' => [
                'street' => 'WallStreet',
    ...
    public function it_should_handle_matching_objects()
    {
        $this->beConstructedWith([
            'name' => Pact::like('some'),
    ...
    public function it_should_serialize_when_nested_values()
    {
        $this->beConstructedWith([
            'match' => Pact::eachLike(
                Pact::eachLike([
